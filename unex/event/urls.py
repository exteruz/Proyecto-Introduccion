...
from .views import ListCategoryView,eventdetail
...
urlpatterns = [
    ...
    path('verEvento/<int:pk>',eventdetailview.as_view(),name="verEvento"),
    ...
    path('probando_event' , eventdetail.as_view(), name="probando"),
